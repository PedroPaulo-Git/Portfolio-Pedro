      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 lg:w-full">
        ...
        <div className="h-32 p-2 text-center flex items-center bg-gray-50 shadow-lg border-b">
          <div className="text-xl w-full">
            <span className="font-bold" dangerouslySetInnerHTML={{ __html: t('about_grid.value1') }} />
            <br />
            <span className="text-base text-gray-light">{t("about_grid.label1")}</span>
          </div>
        </div>
        ...
        <div className="h-32 p-2 text-center flex items-center bg-gray-50">
          <div className="text-xl w-full">
            <span className="font-bold" dangerouslySetInnerHTML={{ __html: t('about_grid.value2') }} />
            <br />
            <span className="text-base text-gray-light">{t("about_grid.label2")}</span>
          </div>
        </div>
        
        <div className="h-32 p-2 text-center flex items-center bg-gray-50">
          <div className="text-xl w-full">
            <span className="font-bold" dangerouslySetInnerHTML={{ __html: t('about_grid.value3') }} />
            <br />
            <span className="text-base text-gray-light">{t("about_grid.label3")}</span>
          </div>
        </div>
        ...
        <div className="h-32 p-2 text-center flex items-center bg-gray-50">
          <div className="text-xl w-full">
            <span className="font-bold" dangerouslySetInnerHTML={{ __html: t('about_grid.value4') }} />
            <br />
            <span className="text-base text-gray-light">{t("about_grid.label4")}</span>
          </div>
        </div>
